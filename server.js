...
client.on("message", (message) => {
    ...
    if(message.content.startsWith(prefix + 'new') || message.content.startsWith(prefix + 'تيكت')|| message.content.startsWith(prefix + 'تيكيت')|| message.content.startsWith(prefix + 'تكت')) {
              ...
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  message.guild.channels.find("name" , room).send(' :heavy_check_mark: **GIVEAWAY** :heavy_check_mark:' , {embed: giveEmbed}).then(m => {
                    ...
                    message.guild.channels.find("name" , room).send(`**Congratulations ${gFilter}! انت ربحت القيف اواي \`${title}\`**` , {embed: {}})
                     },duration);
                   });
                } catch(e) {
...
client.on('message' , message => {
    ...
    if(message.content.startsWith(prefix + 'unban')) {        if(!message.member.hasPermission('ADMINISTRATOR')) return message.channel.send('❌|**\`ADMINISTRATOR\`لا توجد لديك رتبة`**');
...
message.channel.send(embed)
   ...
   client.on('message', message => {
	var prefix = "-";
    if(message.content.startsWith(prefix + 'moveall') || message.content.startsWith(prefix + 'سحب الكل')) {
 ...
 let array_of_mentions = message.mentions.users.array();
  ...
  if (array_of_mentions.length == 1 || array_of_mentions.length == 2) {
    ...
    message.reply(`منشن مع من تريد العب`)
...
client.on("message", tin => {
  if(tin.content === prefix + "help" || tin.content === prefix + "HELP" || tin.content === prefix + "Help" || tin.content === prefix + "HElp" || tin.content === prefix + "HELp"){////هنا  الامر
           tin.react("✅")
     const embed = new Discord.RichEmbed() 
         .setColor("#RANDOM")
         .setDescription(`
...
client.on("message", message => {
  ...
  var die = new Discord.MessageEmbed()
      .setColor("RED")// حط اللون الي تبيه .
...
> -moveall,سحب الكل | Move all to your room
> -move | Move member to a voice room
> -giveaway,قيف اواي | Creating giveaway
> -role,تفضل,رول @mention | To give role to a particular member. 
> -status | The status of the members
> -clear,مسح <numbr> | clear chat
> -mute,اسكت @user <reason> | mute member
> -unmute,تكلم @user | unmute member
> -kick,طرد @user <reason> | Kick Member From server
> -ban,باند @user <reason> | ban member from server
> -unban,فك @user <reason> | unban member
> -lock,قفل | Lock Chat
> -unlock,افتح | unlock Chat
...
> -cut I لعبة كت تويت
> -هل تعلم I لعبة هل تعلم
> -حكم I البوت يعطيك حكم ولازم يتنفذ
> -جمع I يعطيك مسألة تجمعها
> -طرح I يعطيك مسألة تطرحها
> -ضرب I يعطيك مسألة ضرب
> -اسرع I لعبة اسرع لازم تكتب الكلمة بسرعه
> -فكك I يعطيك كلمه ولازم تفكك الكلمة
> -صراحه I لعبة صراحة
> -عقاب I البوت يعطيك عقاب ولازم يتنفذ
> -سؤال I البوت يعطيك سؤال وحاول تجاوبه
> -عواصم I لعبة عواصم
> -نكت I البوت يعطيك نُكته**`)
  .setThumbnail(message.author.avatarURL())
...
client.on('TinBot', TinBot => {
    if(TinBot.content.startsWith(prefix + 'fkk') || TinBot.content.startsWith(prefix + 'فكك')) {
        var x = ["محمد",
"مدرسة",
"بيت",
"الله",
...
لديك 20 ثانية`).then(msg1=> {
        ...
        r.catch(() => {
            return TinBot.channel.send(`:negative_squared_cross_mark: لقد انتهى الوقت ولم يقم أحد بالأجابة بشكل صحيح 
            الإجآبة الصحيحة هي __**${x2[x3]}**__`)
        })
        
        r.then((collected)=> {
            TinBot.channel.send(`${collected.first().author}لقد قمت بتفكيك كلمة في وقت مناسب`);
        })
        })
    }
})
...
if (!message["member"]["hasPermission"]('MANAGE_GUILD')) return message["channel"].send(`**❌\`| You Not Have Permission\`**`)
let args = message["content"]["split"](" ");
...
let embed = new Discord.RichEmbed()
.setColor('#ffffff')
.setDescription(`**Done Create Role | ✅**`)
...
client.on("message", message => {
  ...
  if (command == prefix + "tax") {
    ...
    let taxemb = new Discord.RichEmbed()
      ...
      .setDescription(`المبلغ المحدد: **${numerr}**\nقيمة الضريبة: **${tax}%**\nالمبلغ من الضريبة: **${taxval}**\nالتحويل المباشر: **${amount}**\nالتحويل لطرفين: **${amountfinal}**`)
      .setTimestamp()
      .setFooter(`Requested By ${message.author.username}`, message.author.avatarURL);
...
client.on('message', message => {
    ...
    if(message.content === (prefix + 'lock') || message.content.startsWith(prefix + 'قفل')) {
                        if(!message.channel.guild) return message.reply('** This command only for servers ❌ **');
...
if(!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply
 ...
 if(message.content === (prefix + 'unlock') || message.content.startsWith(prefix + 'افتح')|| message.content.startsWith(prefix + 'فتح')) {
                     if(!message.channel.guild) return message.reply('** This command only for servers ❌ **');
...
client.on("message", msg => {
  ...
  if (msg.author.bot) return;
let devs = ["الايدي الخاص بشخص اخر","616709497817268281"];
...
**🔗 Server:** ${ot.guild.name}`)
            .setTimestamp()
           .setFooter(`🔰 Guild ID : ${tin.guild.id}`) 
            ot.user.send(embed); 
}
});
